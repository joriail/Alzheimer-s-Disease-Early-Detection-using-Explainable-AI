...
# ✅ Secret key من متغير البيئة (أكثر أماناً للـ Production)
app.secret_key = os.environ.get("FLASK_SECRET_KEY", "change_this_secret_key_to_something_more_secure")

USERS_DB_PATH = os.environ.get("USERS_DB_PATH", "users_auth.json")
PATIENTS_DB_PATH = os.environ.get("PATIENTS_DB_PATH", "patients.db")
...
ARTIFACTS_PATH = os.environ.get("ARTIFACTS_PATH", os.path.join("artifacts", "model_artifacts.pkl"))
...
def patient_dashboard():
    ...
    try:
        features_dict = json.loads(record[8])
